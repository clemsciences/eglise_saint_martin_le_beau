                  ...
                  SelectableText.rich(
                    TextSpan(
                      children: [
                        TextSpan(
                          text:
                              "Saint-Martin-le-Beau tient sa spécificité de saint Martin lui-même. "
                              "Ce n'est pas durant sa vie qu'il a donné son importance à la ville, mais c'est le culte porté à son encontre qui a permis à ce village de gagner un nom significatif en Touraine.\n",
                        ),
                        TextSpan(
                          text:
                              "Le premier historien franc, Grégoire de Tours, qui a entre autres raconté la vie et la mort des rois mérovingiens, a raconté la vie et l'influence de saint Martin en Touraine. Bien que celui-ci a contribué à christianiser les territoires aux alentours, il n'avait pas été fait mention d'une ville pouvant s'apparenter à notre Saint-Martin-le-Beau d'aujourd'hui ",
                        ),
                        LinkTextSpan(urlText: "[PT22]", url: "/sources"),
                        TextSpan(text: "."),
                      ],
                    ),
                  ),
